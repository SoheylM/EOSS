...
//            args[0] = "/Users/nozomihitomi/Dropbox/EOSS/problems/decadalScheduling";
            args[0] = "C:\\SEAK Lab\\SEAK Lab Github\\EOSS\\EOSS-AIAA\\problems\\climateCentric";
            args[1] = "1"; //Mode
            args[2] = "1"; //numCPU
            args[3] = "1"; //numRuns
        }
        ...
        quine(new File(String.join(File.separator, new String[]{System.getProperty("user.dir"),"EOSSAIAA","src","main","java","eoss","problem","RBSAEOSSSMAP.java"})),
